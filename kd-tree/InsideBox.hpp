...
public:
    ...
    void cudaMain(int number_of_trees, int tree_size, T *treeArray_values, int *treeArray_ID, T box[],  int number_of_dimensions,  T treeArray_x[], T treeArray_y[], T treeArray_z[]);
